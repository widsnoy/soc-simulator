TOP_NAME := mycpu_top
SRC_DIR  := /home/widsnoy/git-projects/MyCPU/build
...
obj_dir/V$(TOP_NAME): src/* $(INC_FILE)
	verilator --cc -Wno-fatal --exe --trace --trace-structs --build src/sim_nscscc.cpp -CFLAGS $(CFLAG) $(INC_FILE) $(INC_DIR) --top $(TOP_NAME) -j `nproc`
